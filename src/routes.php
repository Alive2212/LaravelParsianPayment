...
//                    Route::get('', 'AliveParsianPaymentController@index')->name('mobile_passport.role.index');
...
//                Route::prefix('parsian')->group(function () {
//                    Route::prefix('payment')->group(function () {
//                        Route::post('init', 'CustomParsianPaymentController@init')->name('parsian_payment.custom.init');
